	...
	while queue : 
		...
		if not(rvisited[ri][rj] and bvisited[bi][bj]) :
			...
			if (ri, rj) != tr or (bi, bj) != tb :
				...
				# dic에 넣어서 관리할 예정
				dic["상"] = ((ri, rj), (bi, bj), count + 1, validate(code_list))
		...
		if not(rvisited[ri][rj] and bvisited[bi][bj]) :
			...
			if (ri, rj) != tr or (bi, bj) != tb :
				...
				# queue.append(((ri, rj), (bi, bj), count + 1))
				dic["하"] = ((ri, rj), (bi, bj), count + 1, validate(code_list))
		...
		if not(rvisited[ri][rj] and bvisited[bi][bj]) :
			...
			if (ri, rj) != tr or (bi, bj) != tb :
				...
				# queue.append(((ri, rj), (bi, bj), count + 1))
				dic["좌"] = ((ri, rj), (bi, bj), count + 1, validate(code_list))
		...
		if not(rvisited[ri][rj] and bvisited[bi][bj]) :
			...
			if (ri, rj) != tr or (bi, bj) != tb :
				...
				# queue.append(((ri, rj), (bi, bj), count + 1))
				dic["우"] = ((ri, rj), (bi, bj), count + 1, validate(code_list))
