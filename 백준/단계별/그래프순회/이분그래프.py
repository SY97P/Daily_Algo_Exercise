...
# 		if visited[node] != 0 and visited[node] != code : 
# 			print("False")
# 			return False

# 		visited[node] = code

# 		print(node, code, visited[1:])

# 		for ad in adj[node] :
# 			if visited[ad] == 0 : 
# 				next_code = 0 if code != 0 else 1
# 				visited[ad] = next_code
...
# 	for node in range(1, v+1) :
# 		visited[node] = 1
# 		if not bfs(deque([(node, visited[node])]), visited) :
# 			para = True
# 			break
