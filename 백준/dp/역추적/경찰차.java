...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
		...
		BufferedReader br = new BufferedReader(new FileReader("./백준/dp/역추적/경찰차.txt"));
        ...
        System.out.println(String.valueOf(police(1,0,0))+"\n");
        ...
        for(int index=1;index<=event_num;index++){
			...
			System.out.println(dp[index_one][index_two]);
			System.out.println(one_remain);
			System.out.println(dp[index_one][index_two] - one_remain);
			System.out.println(dp[index][index_two]);
			System.out.println();
